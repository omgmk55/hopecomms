            ...
            <div id="chat-window" class="hidden flex flex-col w-[350px] h-[500px] bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden transition-all duration-300 transform origin-bottom-right mb-4">
                ...
                <div class="p-4 bg-white border-t border-gray-100 flex-shrink-0">
                    <form id="chat-form" class="flex space-x-2">
                        <input type="text" id="chat-input" placeholder="Écrivez votre message..." class="flex-1 px-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:border-lime-500 focus:ring-1 focus:ring-lime-500 text-sm">
